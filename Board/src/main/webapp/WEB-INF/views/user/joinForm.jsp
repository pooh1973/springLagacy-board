...
<div class="container">
  <form action="/user/join" method="POST" name="form">
    ...
    <div class="form-group">
      <button type="button" class="btn btn-warning" onClick="goPopup();" value="팝업_domainChk">주소검색</button>
      <input name="userAddr" type="text" class="form-control" placeholder="Enter userAddr" readonly="true" />
    </div> 
